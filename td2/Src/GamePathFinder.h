...
// TODO TD2 
class NewCommand: public PathFinderCommand  {
private:
	const osg::Vec3 center;
	float size;
public:
	// Herited virtual pur methods
	virtual void onPathFinderReady(PathFinder & pf) override;
	virtual bool onPathFinderModified(GamePathFinder * gpf) override;

	// Constructor 
	NewCommand(int priority, const osg::Vec3 & center, float size)
		: PathFinderCommand(priority), center(center), size(size){}
};
